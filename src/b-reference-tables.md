...
Sanity rule from [chapter 3](03-the-numbers-that-matter.md): a quoted latency that falls *between* rungs (e.g., "10 µs disk read") is probably a fiction — the ladder doubles as a fraud detector.
