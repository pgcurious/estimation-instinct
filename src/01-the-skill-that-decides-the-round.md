...
First, **the five minutes are a budget, not a target.** Estimating for twelve minutes is its own red flag — it says you can't tell which numbers matter. [The interview script](22-the-interview-script.md) covers the room-craft of entering and exiting the phase cleanly.
...
That's the book's thesis, and the next three chapters cash it out. The anchors are [chapter 3](03-the-numbers-that-matter.md) and fit on [one page](a-cheat-sheet.md). The procedure is [the Ladder](04-the-ladder.md) — users → actions → bytes → machines → money, the same five rungs for every system anyone has ever been asked to design. The reps are Part III plus [fifteen minutes a day](24-the-30-day-program.md). There is no fourth ingredient, and none of the three is talent.
