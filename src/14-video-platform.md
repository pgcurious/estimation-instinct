...
[Chapter 7](07-bandwidth.md) taught that egress runs the bill. This is the scale where it stops running the bill and breaks the price list instead. Buy delivery at the canon CDN rate:
