...
The latency pair, the 80/20 law, the 100 k ops ceiling, the 128 GB box and the 1 KB row are [cheat-sheet](a-cheat-sheet.md) canon; the ~100 GB usable and the ~100 B key tax are this chapter's planning numbers — derived above, stated as assumptions in the room.
