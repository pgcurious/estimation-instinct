...
Everything here is [cheat-sheet](a-cheat-sheet.md) canon except the ~10-server crossover and the over-sharding defaults — those are this chapter's contribution: defaults to state out loud, not laws.
