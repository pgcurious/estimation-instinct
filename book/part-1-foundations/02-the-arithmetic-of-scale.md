...
**A million things of 1 KB each is a GB.** 10^6 × 10^3 = 10^9. The [cheat sheet](../appendices/a-cheat-sheet.md) calls that sentence, as reflex, half this book — because every storage estimate you'll ever do is that sentence in different clothes:
...
The day's rounding is the famous one — up to 10^5, rates under-counted ~15%, the peak factor pays the debt ([chapter 5](../part-2-core-estimations/05-traffic.md) prices that trade). The year has a mnemonic too good to skip: **a year is π × 10^7 seconds** — accurate to half a percent, meaningful not at all, unforgettable anyway. Compute with 3 × 10^7; remember with π. The month earns its keep through one trick: dividing by 2.5 is multiplying by 4 — so monthly volumes become per-second rates in a single move: ×4, knock 7 off the exponent.
...
Bits are the 8× cousin: networks quote bits per second, storage counts bytes. 1 Gbps moves 125 MB/s; a 10 Gbps NIC, 1.25 GB/s. [Chapter 7](../part-2-core-estimations/07-bandwidth.md) owns the doctrine; install the reflex now: **lowercase b — divide by 8 before any other move.**
...
If you said 10,000, you read Gb as GB — the 8× bug. Lowercase b: divide by 8 before any other move ([chapter 7](../part-2-core-estimations/07-bandwidth.md) owns the rest).
</details>
...
---
[← Previous: The skill that decides the round](01-the-skill-that-decides-the-round.md) · [Table of contents](../../README.md) · [Next: The numbers that matter →](03-the-numbers-that-matter.md)
