...
**Post store.** Writes: 3,000 peak TPS ÷ 1,000 per SQL node = 3 shards → over-provision to 8 so you never re-shard in a hurry ([Machines & shards](../part-2-core-estimations/09-machines-and-shards.md)), sharded by *author* id, ×3 replication ≈ 24 boxes. One caveat said aloud: at 180 TB/year provisioned, size — not write rate — reopens the sharding conversation within a year or two. The senior move is aging old posts out of the hot store; feeds only ever read the recent end.
...
---
[← Previous: URL shortener](11-url-shortener.md) · [Table of contents](../../README.md) · [Next: Chat →](13-chat.md)
